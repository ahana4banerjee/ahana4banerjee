...
I build **AI-driven full-stack** systems that solve real-world problems — from intelligent finance learning platforms to agentic career guidance tools.
Currently strengthening my core foundations in **DSA, DBMS, Operating Systems, and system design**, while actively contributing to open-source and building scalable cloud-deployed applications.
...
- **_FinSwarm_** — Agentic AI financial learning platform using Google AI Studio  
- **_Project Inocula_ (v2)** — Scaling with real-time alerts and proactive misinformation scanning

---

## Highlights
- **15+ merged PRs** as Open Source Contributor (GSSoC’25)  
- Built **3+ production-ready full-stack apps & AI systems**  
- Hands-on experience with **MERN, PERN, FastAPI, Agentic AI, and Cloud deployment**
